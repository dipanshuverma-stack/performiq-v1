        ...
        <div className="grid w-full max-w-6xl gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg text-slate-400">
              Track syllabus progress, manage revisions, analyze performance and prepare smarter for SBI PO, IBPS PO and RRB PO.
            </p>

            <div className="mt-10 space-y-4">
              {[
                { emoji: "📚", text: "Syllabus Intelligence" },
                { emoji: "🔁", text: "Smart Revision Engine" },
                { emoji: "⚡", text: "Practice Analytics" },
                { emoji: "📈", text: "Mock Intelligence" },
              ].map((item, i) => (
          ...
          <div className="flex items-center">
            <div className="w-full rounded-3xl border border-white/[0.08] bg-[#0E121B] p-10 backdrop-blur-xl">
              ...
              >
                <button
                  type="submit"
                  className="w-full rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 py-4 font-semibold text-white transition-all hover:from-blue-500 hover:to-indigo-500 hover:scale-[1.01] active:scale-[0.98] disabled:opacity-70"
                >
