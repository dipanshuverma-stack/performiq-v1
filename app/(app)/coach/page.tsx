      ...
      {!hasCoachData ? (
        <div className="bg-white rounded-xl shadow p-12 text-center border">
          ...
          <p className="text-gray-400 text-sm mb-6 max-w-md mx-auto">
            Complete practice sessions, revision tasks, and mock tests to unlock tailored recommendations.
          </p>
        ...
        <>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
            ...
            <p className="text-blue-800">
              ...
              {coach.messages.length} coaching {coach.messages.length === 1 ? "recommendation" : "recommendations"} generated for your track.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow border p-6">
            ...
            <ul className="space-y-3.5">
              {coach.messages.map((message, index) => (
                <li
                  key={`${message}-${index}`}
                  className="text-gray-700 flex items-start gap-3 text-sm md:text-base"
                >
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {coach.focusTopics.map((topic, index) => (
                <div 
                  ...
                  className="p-4 rounded-lg border bg-gray-50 border-gray-100 flex items-center justify-between"
                >
