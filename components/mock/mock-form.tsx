...
export default function MockForm() {
  ...
  const defaultTopics = { Reasoning: [], Quant: [], English: [], GA: [], Computer: [] };
  const [weakTopics, setWeakTopics] = useState<Record<string, string[]>>(defaultTopics);
  const [strongTopics, setStrongTopics] = useState<Record<string, string[]>>(defaultTopics);
