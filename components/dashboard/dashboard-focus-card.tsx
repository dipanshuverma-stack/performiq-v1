...
export const DashboardFocusCard = React.memo(function DashboardFocusCard({
  ...
  const masteryColor = mastery >= 75 ? "text-emerald-400" : "text-amber-400";

  return (
    <GlassCard className="p-5 flex items-center justify-between gap-4 cursor-pointer group hover:border-white/[0.12] hover:bg-white/[0.05] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-indigo-500/5 transition-all duration-200">
