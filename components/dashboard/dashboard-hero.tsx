      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 text-sm">
            {activeExam ? (
              <span className="text-indigo-400 font-medium">{activeExam} Target Mode</span>
            ) : (
        ...
        {/* Right Side: Fixed Width Metrics Panel */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:border-l lg:border-white/[0.08] lg:pl-8 lg:w-[420px]">
