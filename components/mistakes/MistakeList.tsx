...
interface MistakeItem {
  ...
  topic: string;
  question: string;
  explanation: string | null; // ✅ Safely handles nullable entries
  resolved: boolean;
  createdAt: Date;
  source?: string | null;
  difficulty?: any;           // ✅ Flexible typing prevents "never" assignment errors
  confidenceScore?: any;
  notes?: string | null;
}
                  ...
                  {subMeta && (
                    <span 
                      ...
                      style={{
                        ...
                        color: `var(--${subMeta.color}-400, #818cf8)`, // ✅ Fixed property token name from 'textColor' to 'color'
              ...
              {isExpanded && (
                <div className="px-4 pb-5 pt-2 border-t border-dashed border-white/[0.06] bg-[#090D16]/40 text-sm space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Target Problem Text</h4>
                  ...
                  {/* Explanation block with nullable verification fallback layout handles */}
                  <div className="space-y-1.5">
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Calibration Breakdown</h4>
