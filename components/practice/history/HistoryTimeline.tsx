...
// ✅ Robust timestamp evaluation avoiding DST calendar shifts
function formatRollingMarker(dateInput: Date): { group: "Today" | "Yesterday" | "Last 7 Days" | "Last 30 Days" | "Older"; relativeTime: string } {
  const target = new Date(dateInput);
  const diffMs = Date.now() - target.getTime();
  const diffDays = Math.floor(diffMs / 86400000); // Absolute 24-hour block chunks
