    ...
    <GlassCard glow className="p-6">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-2xl border border-white/[0.06] bg-black/30 p-6 transition-all duration-300 hover:border-white/[0.08] hover:bg-white/[0.02]">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-black/30 p-6 transition-all duration-300 hover:border-white/[0.08] hover:bg-white/[0.02]">
            ...
            <h3 className="mt-3 text-2xl font-semibold text-white truncate">
              {topic}
            </h3>
          </div>
